...
from dataloaders.drive import Drive, RandomCrop, CenterCrop, RandomRotFlip, ToTensor, TwoStreamBatchSampler
...
if __name__ == "__main__":
    ...
    db_train = Drive(base_dir=train_data_path,
    ...
    unlabeled_idxs = list(range(labelnum, 20))
